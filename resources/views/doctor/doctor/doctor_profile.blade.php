                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $doctor->slug }}" name="slug" id="slug-input" class="form-control @error('slug') is-invalid @enderror" onblur="updateSampleUrl()">
                            <label class="col-form-label">Preview: <span id="sample_url" style="font-size:10px;">{{url('/')}}</span></label>
                            @error('slug')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <script>
                            function updateSampleUrl() {
                                // Get the value of the slug input
                                var slugInput = document.getElementById("slug-input");
                                var slugValue = slugInput.value;

                                // Process the slug: replace spaces with dashes, convert to lowercase, and replace all other symbols with dashes
                                var processedSlug = slugValue
                                    .toLowerCase() // Convert to lowercase
                                    .replace(/\s+/g, '-') // Replace spaces with dashes
                                    .replace(/[^a-z0-9-]+/g, '-'); // Replace all other symbols with dashes

                                // Get the sample URL element
                                var sampleUrlElement = document.getElementById("sample_url");

                                // Define the base URL
                                var baseUrl = "{{ url('/') }}";

                                // Update the sample URL with the processed slug
                                sampleUrlElement.innerText = baseUrl + "/" + processedSlug;

                                // Update the value of the slug input with the processed slug
                                slugInput.value = processedSlug;
                            }
