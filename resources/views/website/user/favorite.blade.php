                        ...
                        <div class="w-full h-full border-l border-white-light pl-5 relative">
                            ...
                            <div class="flex flex-col justify-center">
                                ...
                                <div class="flex mt-5 mb-2">
                                    ...
                                    <a href="{{ url($doctor['slug'])) }}" class="font-fira-sans text-primary text-sm font-normal leading-4 underline 2xl:mx-5 xl:mx-5 xlg:mx-2 lg:mx-2 md:mx-5 lg:py-3 xmd:py-2 md:py-2 sm:py-0 msm:py-2 xsm:py-2 xxsm:py-2">{{__('View Profile')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
